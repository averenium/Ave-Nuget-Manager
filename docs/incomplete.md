...
- Sources — можна змінити on/off, credentials, API key, mapping-патерни існуючого джерела, додати нове package/audit джерело (#48) і видалити джерело (package чи audit). Немає очищення orphaned mapping/credentials/disabled-записів при видаленні джерела.
